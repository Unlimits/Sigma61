...
type
  TConfForm = class(TForm)
    ...
    procedure CheckBox1Click(Sender: TObject);{kotov}
  private
...
'28. Размер оболочки, ширина ленты матрицы (MAIN)', '29. Резерв', '30. Затраты памяти схем хранения (MEMCNT)','31.  Перемещения узлов (MAIN)','32.  Напряжения в КЭ (STRDD)');
var
  ConfForm: TConfForm;
